...
# )
# parameter_stval <- c(-0.39, 0.126, 0.7, 0.021, 17, 12, 12, 4)
...
# )
#
# parameter_stval <- c(-0.39, 0.126, 0.7, 0.021, 20, 5)
...
llk.logit <- function(param) {
  ...
  param_regression <- param[1:3]
  param_sigmas <- param[4:5]
...
# saveRDS(result1, "data/results_hosp_nonhosp_educonly.RDS")
